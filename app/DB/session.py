...
engine = create_async_engine(settings.DB_URL,echo=False,pool_pre_ping=True) ## this will connect to the db url specified in app/config/config
                                                                            # pool_pre_ping=True checks dead connections before use
